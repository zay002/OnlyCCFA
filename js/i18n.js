const onlyccfaI18n = {
  messages: {
    zh: {
      ...
      sortSection: "当前页排序",
      sortDefault: "默认顺序",
      sortCitationsDesc: "引用数高到低",
      sortCitationsAsc: "引用数低到高",
      batchSize: "每批数量",
      deepSearch: "开始 / 继续",
      clearDeep: "清空结果池",
      exportSection: "导出",
    ...
    en: {
      ...
      showSelectedTagsOnly: "Selected tags only",
      any: "Any",
      all: "All",
      ...
      sortSection: "Current Page Sort",
      sortDefault: "Default order",
      sortCitationsDesc: "Citations high to low",
      sortCitationsAsc: "Citations low to high",
