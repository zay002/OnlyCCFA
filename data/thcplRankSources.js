const thcplRankSources = {
  sources: {
    thcpl: {
      label: "THCPL ",
      className: "rank-source-thcpl",
    },
  },
  records: [
    {
    ...
    {
      title: "USENIX Conference on File and Storage Technologies",
      aliases: ["FAST"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Mass Storage Systems and Technologies",
      aliases: ["MSST"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Design, Automation & Test in Europe Conference",
      aliases: ["DATE"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM Symposium on Parallelism in Algorithms and Architectures",
      aliases: ["SPAA"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Hot Chips: A Symposium on High Performance Chips",
      aliases: ["HOT CHIPS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Symposium on Physical Design",
      aliases: ["ISPD"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE International Electron Devices Meeting",
      aliases: ["IEDM"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE Journal of Selected Areas in Communications",
      aliases: ["JSAC"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Mobile Networks & Applications",
      aliases: ["MONET"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Symposium on Network System Design and Implementation",
      aliases: ["NSDI"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "The Workshop on Hot Topics in Networks",
      aliases: ["HotNets"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IFIP International Conferences on Networking",
      aliases: ["Networking"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE Wireless Communications & Networking Conference",
      aliases: ["WCNC"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Architectures for Networking and Communications Systems",
      aliases: ["ANCS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title:
        "The International Symposium on Modeling and Optimization in Mobile, Ad Hoc, and Wireless Networks",
      aliases: ["WiOpt"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM Conference on Information Centric Networking",
      aliases: ["ICN"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Conference on Network and Service Management",
      aliases: ["CNSM"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Cryptographer's Track at RSA Conference",
      aliases: ["CT-RSA"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Passive and Active Network Measurement Conference",
      aliases: ["PAM"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Asia Conference on Computer and Communications Security",
      aliases: ["AsiaCCS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM Workshop on Information Hiding and Multimedia Security",
      aliases: ["IH&MMSec"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IFIP International Information Security Conference",
      aliases: ["SEC"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE/IFIP Network Operations and Management Symposium",
      aliases: ["NOMS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Future Generatlon Computer Systems",
      aliases: ["FGCS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Computational complexlty",
      aliases: ["CC"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM Symposium on the Theory of Computing",
      aliases: ["STOC"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title:
        "International Conference on Automated Deduction/lnternational Joint Conference on Automated Reasoning",
      aliases: ["CADE/IJCAR"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM Symposium on Computational Geometry",
      aliases: ["SoCG"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title:
        "Scandinavian Symposium and Workshops on Algorithm Theory/ the Algorithms and Data Structures Symposium",
      aliases: ["SWAT/WADS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Software and System Modeling",
      aliases: ["SOSyM"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Requlrements Englneerlng",
      aliases: ["RE"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "USENIX Symposium on Operating Systems Design and implementations",
      aliases: ["OSDI"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Middleware Conference",
      aliases: ["Middleware"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title:
        "IEEE International Conference 0 n Software Testing, Verification and Validation",
      aliases: ["ICST"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Conference on Function Programming",
      aliases: ["ICFP"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE International Requirement Engineering Conference",
      aliases: ["RE"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title:
        "International Conference on Advanced Informatlon Systems Engineering",
      aliases: ["CAiSE"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title:
        "International Conference on Verification, Model Checking, and Abstract Interpretatlon",
      aliases: ["VMCAI"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Symposium on Software Reliabillty Engineering",
      aliases: ["ISSRE"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Symposium on Formal Methods",
      aliases: ["FM"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Conference on Embedded Software",
      aliases: ["EMSOFT"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Conference on Service Computing",
      aliases: ["SCC"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Conference on Web Services (Research Track)",
      aliases: ["ICWS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Conference on Very Large Data Bases",
      aliases: ["VLDB"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM Symposium on Principles Of Database Systems",
      aliases: ["PODS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE International Semantic Web Conference",
      aliases: ["ISWC"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "European Conference on IR Research",
      aliases: ["ECIR"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Conference on Extending Database Technology",
      aliases: ["EDBT"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "International Conference on Innovative Data Systems Research",
      aliases: ["CIDR"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE Transactions on Affective Comput'ng",
      aliases: ["TAC"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Pattern Recognltlon Letters",
      aliases: ["PRL"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Conference on Recommender Systems",
      aliases: ["RecSys"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "SIAM Journal on Imaging Sciences",
      aliases: ["SilMS"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "Symposium on Solid and Physical Modeling",
      aliases: ["SPM"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM/Eurographics Symposium on Computer Animation",
      aliases: ["SCA"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE International Conference on Acoustics, Speech and SP",
      aliases: ["ICASSP"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM Symposium on Interactive 3D Graphics",
      aliases: ["SI3D"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "IEEE Pacific Visualization Symposium",
      aliases: ["PacificVis"],
      tags: [
        {
          source: "thcpl",
    ...
    {
      title: "ACM International Conference on Multimodal Interaction",
      aliases: ["ICMI"],
      tags: [
        {
          source: "thcpl",
