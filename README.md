...
- 提供实验性 Zotero 本地导入入口，向 Zotero Connector 发送论文网页和 PDF 附件线索，而不是把不完整的搜索摘要伪装成正式引用。
...
- 多源标签组合筛选。
- Google 学术 / Crossref / arXiv BibTeX 获取、Google 学术 BibTeX 链接设置、BibTeX 解析和 Zotero 网页/PDF 条目转换。
- 筛选偏好保存和未识别结果处理。
- 筛选统计信息。
- Google 学术 venue 提取。
